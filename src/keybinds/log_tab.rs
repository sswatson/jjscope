...
impl LogTabKeybinds {
    ...
    pub fn make_main_panel_help(&self) -> Vec<(String, String)> {
        make_keybinds_help!(
            ...
            LogTabEvent::CreateNew { describe: false } => "new change (@ stays put; e edits into it)",
            LogTabEvent::CreateNew { describe: true } => "new change with message (@ stays put)",
            ...
            LogTabEvent::Squash { ignore_immutable: false } => "squash",
