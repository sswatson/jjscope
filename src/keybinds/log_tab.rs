...
impl LogTabKeybinds {
    ...
    pub fn make_main_panel_help(&self) -> Vec<(String, String)> {
        make_keybinds_help!(
            ...
            LogTabEvent::InsertNew => "insert new change between marked changes",
            LogTabEvent::InsertMove => "move selected change between marked changes",
            ...
            LogTabEvent::Rebase => "rebase the selected change onto the marked change(s)",
            LogTabEvent::Squash { ignore_immutable: false } => "squash the selected change into its parent, or into the marked change",
            LogTabEvent::Squash { ignore_immutable: true } => "squash the selected change into its parent or the marked change, ignoring immutability",
